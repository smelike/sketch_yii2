    ...
    var d = {
      ...
      init: function (b, c) {
        ...
        return (
          ...
          (document.cookie =
            "__fileupload_dest_dir=" + escape(this.options.dest_dir)),
          (document.cookie =
            "__fileupload_global=" + escape(this.options.global)),
          a("#modal-webuploader").remove(),
          0 == a("#modal-webuploader").length &&
            a(document.body).append(d.buildHtml().mainDialog),
          (d.modalobj = a("#modal-webuploader")),
          d.modalobj.modal("show"),
          d.modalobj.on("shown.bs.modal", function () {
            a(this).data("init") ||
              ("image" == d.options.type && (d.initRemote(), d.initLocal()),
              "audio" == d.options.type && d.initLocalAudio(),
              d[
                "init" +
                  d.options.type.substring(0, 1).toUpperCase() +
                  d.options.type.substring(1) +
                  "Uploader"
              ]());
          }),
          d.modalobj
      ...
      initImageUploader: function () {
        ...
        var i = this;
        i.modalobj.find("#li_upload a").html("上传图片"),
