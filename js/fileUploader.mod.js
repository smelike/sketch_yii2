define([
  ...
  var d = {
    ...
    init: function (b, c) {
      var d = this;
      return (
        (d.options = a.extend({}, d.defaultoptions, c)),
        (d.options.callback = b),
        this.options.global ? (this.options.global = "global") : (this.options.global = ""),
        ...
        a("#modal-webuploader").remove(),
        0 == a("#modal-webuploader").length && a(document.body).append(d.buildHtml().mainDialog), // 获取html
        (d.modalobj = a("#modal-webuploader")),
        d.modalobj.modal("show"),
        d.modalobj.on("shown.bs.modal", function () {
            console.log("init:");
            console.log(d);
          a(this).data("init") || (
                "image" == d.options.type && (d.initRemote(), 
                d.initLocal()), "audio" == d.options.type && d.initLocalAudio(),
                d["init" + d.options.type.substring(0, 1).toUpperCase() + d.options.type.substring(1) + "Uploader"]()
            );
        }),
        d.modalobj
      );
    ...
    initRemote: function () {
      ...
      b.modalobj.find("#li_network").removeClass("hide"),
        ...
        b.modalobj.find(".btn-primary").click(function () {
          ...
          c.length > 0 &&
            a.getJSON(
              "./index.php?c=utility&a=file&do=fetch",
              { url: c },
              function (a) {
    ...
    initLocal: function () {
      ...
      a.modalobj.find("#li_history_image").removeClass("hide"),
        a.modalobj.find("#history_image")[0] ||
    ...
    localPage: function (c) {
      ...
      return (
        a.getJSON(
          "./index.php?c=utility&a=file&do=local",
          { page: c, year: e, month: f },
          function (c) {
            (c = c.message),
              g
                .find(".history-content")
                .css("text-align", "center")
                .html('<i class="fa fa-spinner fa-pulse fa-5x"></i>'),
              g.find("#image-list-pager").html(""),
              b.isEmpty(c.items)
                ? g
                    .find(".history-content")
                    .css("text-align", "center")
                    .html('<i class="fa fa-info-circle"></i> 暂无数据')
                : (g.data("attachment", c.items),
                  g.find(".history-content").empty(),
                  g
                    .find(".history-content")
                    .html(b.template(d.buildHtml().localDialogLi)(c)),
                  g.find("#image-list-pager").html(c.page),
                  g.find(".pagination a").click(function () {
                  ...
                  g
                    ...
                    .click(function () {
                      ...
                      return c
                        ? (a.post(
                            "./index.php?c=utility&a=file&do=delete",
                            { id: c },
                            function (a) {
                              "success" != a
                                ? alert(a)
        ...
        d.modalobj
          ...
          .unbind("click")
          .click(function () {
            return a(this).hasClass("btn-info")
              ? !1
              : ("month" == a(this).data("type") &&
                  a(this).data("id") > 0 &&
                  (d.modalobj.find("#select-year .btn-info").data("id") ||
                    (d.modalobj
                      .find("#select-year .btn-select")
                      .removeClass("btn-info"),
                    d.modalobj
                      .find("#select-year .btn-select")
                      .eq(1)
                      .addClass("btn-info"))),
                a(this).siblings().removeClass("btn-info"),
                a(this).addClass("btn-info"),
                void d.localPage(1));
          }),
        g
          .find(".btn-primary")
          ...
          .click(function () {
            ...
            g.find(".img-item-selected").each(function () {
              b.push(
                d.modalobj.find("#history_image").data("attachment")[
                  a(this).attr("attachid")
                ]
              ),
    ...
    initLocalAudio: function () {
      ...
      a.modalobj.find("#li_history_audio").removeClass("hide"),
        a.modalobj.find("#history_audio")[0] ||
          a.modalobj
            .find(".modal-body")
            .append(this.buildHtml().localAudioDialog);
    ...
    localAudioPage: function (c) {
      ...
      return (
        a.getJSON(
          "./index.php?c=utility&a=file&do=local&type=audio&pagesize=5",
          { page: c },
          function (c) {
            (c = c.message),
              e
              ...
              b.isEmpty(c.items) ||
                (e.data("attachment", c.items),
                e.find(".history-content").empty(),
                e
                  .find(".history-content")
                  .html(b.template(d.buildHtml().localAudioDialogLi)(c)),
                e.find("#image-list-pager").html(c.page),
                e.find(".pagination a").click(function () {
        ...
        e
          ...
          .click(function () {
            ...
            e.find(".history-content .btn-primary").each(function () {
              b.push(
                d.modalobj.find("#history_audio").data("attachment")[
                  a(this).attr("attachid")
                ]
              ),
      ...
      a(".audio-player-play").click(function () {
        ...
        if (b) {
          ...
          d.data("control", a(this)),
            ...
            d
              .jPlayer("setMedia", { mp3: a(this).attr("attach") })
              .jPlayer("play"),
            a(this).find("p").hasClass("fa-stop")
              ? d.jPlayer("stop")
              : (c.find(".fa-stop").removeClass("fa-stop").addClass("fa-play"),
                d
                  .jPlayer("setMedia", { mp3: a(this).attr("attach") })
                  .jPlayer("play"));
        }
    ...
    initImageUploader: function () {
      function b(b) {
        ...
        "invalid" === b.getStatus()
          ...
          : (g.text("预览中"),
            ...
            (percentages[b.id] = [b.size, 0]),
            (b.rotation = 0)),
          b.on("statuschange", function (a, d) {
            "progress" === d
              ? f.hide().width(0)
              : "queued" === d && (c.off("mouseenter mouseleave"), e.remove()),
              "error" === a || "invalid" === a
                ? (j(b.statusText), (percentages[b.id][1] = 1))
                : "interrupt" === a
                ? j("interrupt")
                : "queued" === a
                ? (percentages[b.id][1] = 0)
                : "progress" === a && (h.remove(), f.css("display", "block")),
              c.removeClass("state-" + d).addClass("state-" + a);
          }),
          ...
          i.options.multiple && k.find(".fileinput-button").show(),
          c.insertBefore(k.find(".fileinput-button"));
      }
      function e(b) {
        var c = a("#" + b.id);
      ...
      function g() {
        ...
        "ready" === state
          ? (b =
              "选中" + fileCount + "张图片，共" + c.formatSize(fileSize) + "。")
          : "confirm" === state
          ? ((a = d.getStats()),
            a.uploadFailNum &&
              (b =
                ...
                "张图片," +
                a.uploadFailNum +
                '张图片上传失败，<a class="retry" href="#">重新上传</a>失败图片或<a class="ignore" href="#">忽略</a>'))
          : ((a = d.getStats()),
            (b =
              "共" +
              fileCount +
              "张（" +
              c.formatSize(fileSize) +
              "），已上传" +
              a.successNum +
              "张"),
            a.uploadFailNum && (b += "，失败" + a.uploadFailNum + "张")),
          m.html(b);
      }
      function h(a) {
        var b;
        if (a !== state) {
          switch ((n.removeClass("state-" + state), n.addClass("state-" + a),(state = a),state)
            ...
            case "confirm":
              if (
                (p.hide(),
                n.text("确定使用").addClass("disabled"),
                (b = d.getStats()),
                b.successNum && !b.uploadFailNum)
              )
                return void h("finish");
              break;
            case "finish":
              if ((n.removeClass("disabled"), (b = d.getStats()), b.successNum)) {
                if (d.uploadedFiles.length > 0)
                  return i.finish(d.uploadedFiles), void d.resetUploader();
      ...
      var j = a("#uploader"),
        k = a(
          '<ul class="filelist"><li class="fileinput-button js-add-image" id="filePicker2" style="display:none;"> <a href="javascript:;" class="fileinput-button-icon">+</a></li></ul>'
        ).appendTo(j.find(".queueList")),
        l = j.find(".statusBar"),
        m = l.find(".info"),
        n = j.find(".uploadBtn"),
      ...
      var q = {
        ...
        fileSingleSizeLimit: 1258291200,
        auto: !1,
      };
     
      // c 参数是 webuploader 模块
      (q = a.extend({}, q, i.options.uploader)),
        (q.pick.multiple = i.options.multiple),
        (d = c.create(q)),
        (d.uploadedFiles = []),
        d.addButton({
          id: "#filePicker2",
        ...
        (d.resetUploader = function () {
          (fileCount = 0),
            ...
            (accept = 0),
            (d.uploadedFiles = []),
            a.each(d.getFiles(), function (a, b) {
              e(b);
            }),
            d.refresh(),
            d.reset(),
        ...
        (d.onFileQueued = function (a) {
          fileCount++,
            (fileSize += a.size),
            1 === fileCount && (o.addClass("element-invisible"), l.show()),
            b(a),
            h("ready"),
            f();
        }),
        ...
        d.on("uploadSuccess", function (b, c) {
          return c.message
            ? (alert(c.message), void d.resetUploader())
            : void (
                c.attachment &&
                (accept++,
                d.uploadedFiles.push(c),
                a("#" + b.id).append(
                  '<span class="success" style="line-height: 50px;">' +
                    c.width +
                    "x" +
                    c.height +
                    "</span>"
                ),
                a(".accept").text("成功上传 " + accept + " 张图片"))
              );
        }),
        (d.onError = function (a) {
          return "Q_EXCEED_SIZE_LIMIT" == a
            ? void alert(
                "错误信息: 图片大于1111 " +
                  c.formatSize(q.fileSizeLimit) +
                  " 无法上传."
              )
            : "F_DUPLICATE" == a
            ? void alert("错误信息: 不能重复上传图片.")
            : void alert("Eroor: " + a);
        }),
        n.on("click", function () {
          return a(this).hasClass("disabled")
            ? !1
            : void ("ready" === state
                ? d.upload()
                : "paused" === state
                ? d.upload()
                : "uploading" === state && d.stop());
        }),
        m.on("click", ".retry", function () {
          d.retry();
        }),
        m.on("click", ".ignore", function () {}),
        n.addClass("state-" + state),
        f();
    },
    initAudioUploader: function () {
      function b(b) {
        var e = a(
            '<li id="' +
              b.id +
              '"><p class="title" style="top:40px;">' +
              b.name +
              '</p><p class="imgWrap" style="top:30px;"></p></li>'
          ),
          f = a(
        ...
        "invalid" === b.getStatus()
          ? l(b.statusText)
          : (h.text(c.formatSize(b.size) + " kb"),
            (percentages[b.id] = [b.size, 0]),
            (b.rotation = 0)),
          b.on("statuschange", function (a, c) {
            "progress" === c
              ? g.hide().width(0)
              : "queued" === c && (e.off("mouseenter mouseleave"), f.remove()),
              "error" === a || "invalid" === a
                ? (l(b.statusText), (percentages[b.id][1] = 1))
                : "interrupt" === a
                ? l("interrupt")
                : "queued" === a
                ? (percentages[b.id][1] = 0)
                : "progress" === a && j.remove(),
              e.removeClass("state-" + c).addClass("state-" + a);
          }),
          ...
          i.options.multiple && k.find(".fileinput-button").show(),
          e.insertBefore(k.find(".fileinput-button"));
      }
      function e(b) {
        var c = a("#" + b.id);
      ...
      function g() {
          console.log("function g:" , state)
        var a,
          b = "";
        "ready" === state
          ? (b =
              "选中" + fileCount + "个音频，共" + c.formatSize(fileSize) + "。")
          : "confirm" === state
          ? ((a = d.getStats()),
            a.uploadFailNum &&
              (b =
                ...
                "个音频," +
                a.uploadFailNum +
                '个音频上传失败，<a class="retry" href="#">重新上传</a>失败音频文件或<a class="ignore" href="#">忽略</a>'))
          : ((a = d.getStats()),
            (b =
              "共" +
              fileCount +
              ...
              a.successNum +
              "个"),
            a.uploadFailNum && (b += "，失败" + a.uploadFailNum + "个")),
          m.html(b);
      }
      function h(a) {
        var b;
        ...
        if (a !== state) {
          switch (
            ...
            case "finish":
              if (
                (n.removeClass("disabled"), (b = d.getStats()), b.successNum)
              ) {
                if (d.uploadedFiles.length > 0)
                  return i.finish(d.uploadedFiles), void d.resetUploader();
              } else (state = "done"), location.reload();
      ...
      var i = this;
      i.modalobj.find("#li_upload a").html("上传音频"),
        i.modalobj.find(".modal-body").append(this.buildHtml().uploaderDialog);
      var j = a("#uploader"),
        k = a(
          '<ul class="filelist"><li class="fileinput-button js-add-image" id="filePicker2" style="display:none;"> <a href="javascript:;" class="fileinput-button-icon">+</a></li></ul>'
        ).appendTo(j.find(".queueList")),
      ...
      (q = a.extend({}, q, i.options.uploader)),
        ...
        d.on("uploadSuccess", function (b, c) {
          return c.error
            ? (alert(c.message), d.resetUploader(), !1)
            : void (
                c.attachment &&
                (accept++,
                d.uploadedFiles.push(c),
    ...
    buildHtml: function () {
      ...
      return (
        ...
        (a.localDialog =
          ...
          (this.options.multiple ? "" : 'style="display:none;"') +
